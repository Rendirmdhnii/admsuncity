      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4 pb-28 max-w-lg w-full mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3.5">
          ...
          <button 
            ...
            className="bg-white p-4 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col justify-center items-start text-left active:scale-90 transition-all w-full cursor-pointer hover:shadow-lg"
          >
            <div className="bg-blue-600 text-white p-3.5 rounded-2xl mb-3 shadow-lg shadow-blue-600/30">
            ...
            <h3 className="font-extrabold text-slate-800 text-sm mb-0.5 tracking-tight">Perjanjian Sewa</h3>
            <p className="text-[10px] text-slate-500 font-semibold">Kontrak resmi apartemen</p>
          </button>
          ...
          <button 
            ...
            className="bg-white p-4 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col justify-center items-start text-left active:scale-90 transition-all w-full cursor-pointer hover:shadow-lg"
          >
            <div className="bg-emerald-500 text-white p-3.5 rounded-2xl mb-3 shadow-lg shadow-emerald-500/30">
            ...
            <h3 className="font-extrabold text-slate-800 text-sm mb-0.5 tracking-tight">Serah Terima</h3>
            <p className="text-[10px] text-slate-500 font-semibold">Berita acara & kunci</p>
          </button>
          ...
          <button 
            ...
            className="bg-white p-4 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col justify-center items-start text-left active:scale-90 transition-all w-full cursor-pointer hover:shadow-lg"
          >
            <div className="bg-amber-500 text-white p-3.5 rounded-2xl mb-3 shadow-lg shadow-amber-500/30">
            ...
            <h3 className="font-extrabold text-slate-800 text-sm mb-0.5 tracking-tight">Invoice Sewa</h3>
            <p className="text-[10px] text-slate-500 font-semibold">Cetak struk tagihan</p>
          </button>
          ...
          <button 
            ...
            className="bg-white p-4 rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col justify-center items-start text-left active:scale-90 transition-all w-full cursor-pointer hover:shadow-lg"
          >
            <div className="bg-rose-500 text-white p-3.5 rounded-2xl mb-3 shadow-lg shadow-rose-500/30">
            ...
            <h3 className="font-extrabold text-slate-800 text-sm mb-0.5 tracking-tight">Surat Teguran</h3>
            <p className="text-[10px] text-slate-500 font-semibold">Komplain & tagihan rugi</p>
          </button>
