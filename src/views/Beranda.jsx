      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4 pb-28 max-w-lg w-full mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3.5">
          ...
          <button 
            ...
            className="bg-white p-4 rounded-3xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col justify-center items-start text-left active:scale-95 transition-all w-full cursor-pointer hover:shadow-lg"
          >
            <div className="bg-blue-50 text-blue-600 p-3 rounded-2xl mb-3">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
            </div>
            <h3 className="font-extrabold text-slate-700 text-sm mb-1">Perjanjian Sewa</h3>
            <p className="text-[10px] text-slate-400 font-medium">Kontrak resmi apartemen</p>
          </button>
          ...
          >
            <div className="bg-emerald-50 text-emerald-600 p-3 rounded-2xl mb-3">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"></path></svg>
            </div>
            <h3 className="font-extrabold text-slate-700 text-sm mb-1">Serah Terima</h3>
            <p className="text-[10px] text-slate-400 font-medium">Berita acara & kunci</p>
          </button>
          ...
          <button 
            ...
            className="bg-white p-4 rounded-3xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col justify-center items-start text-left active:scale-95 transition-all w-full cursor-pointer hover:shadow-lg"
          >
            <div className="bg-amber-50 text-amber-600 p-3 rounded-2xl mb-3">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2zM10 8.5a.5.5 0 11-1 0 .5.5 0 011 0zm5 5a.5.5 0 11-1 0 .5.5 0 011 0z"></path></svg>
            </div>
            <h3 className="font-extrabold text-slate-700 text-sm mb-1">Invoice Sewa</h3>
            <p className="text-[10px] text-slate-400 font-medium">Cetak struk tagihan</p>
          </button>
          ...
          <button 
            ...
            className="bg-white p-4 rounded-3xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.04)] border border-slate-100 flex flex-col justify-center items-start text-left active:scale-95 transition-all w-full cursor-pointer hover:shadow-lg"
          >
            <div className="bg-rose-50 text-rose-600 p-3 rounded-2xl mb-3">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
            </div>
            <h3 className="font-extrabold text-slate-700 text-sm mb-1">Surat Teguran</h3>
            <p className="text-[10px] text-slate-400 font-medium">Komplain & tagihan rugi</p>
          </button>
